    ...
    <div class="container mt-p1">
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h4 class="my-auto"><i class='bi bi-search'></i> Buscar Pedidos</h4>
                <div class="btn-group">
                    <button type='button' class="btn btn-success" data-bs-toggle="modal"
                        data-bs-target="#nuevoPedido"><span class="bi bi-plus-circle"></span></button>
                </div>
            </div>
            <div class="card-body">
                <?php
                include("modal/registro_pedidos.php");
                include("modal/editar_pedidos.php");
                ?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <input type="text" class="form-control" id="q"
                                placeholder="Buscar por Nombre, Fecha o Códigos" onkeyup='load(1);'>
                        </div>
                        <div class="col-md-4">
