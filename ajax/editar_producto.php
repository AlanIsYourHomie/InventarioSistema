...
if (empty($_POST['mod_codigo'])) {
	...
	$sql = "UPDATE producto SET codigo_producto='" . $codigo . "', nom_Producto='" . $nombre . "', idCategoria='" . $categoria . "',
			Precio_Venta='" . $precio_venta . "', stock=" . $stock . " WHERE idProducto='" . $id_producto . "'";
